...
function checkSalaries(employees, n) {
    return employees.every(item => item.salary.slice(1) > n);
}

console.log(checkSalaries(employees, 2));
...
function checkIsEngineer(employees) {
    return employees.every(item => item.isEngineer);
}


console.log(checkIsEngineer(employees));


// 38. Write a function to check if all employees are Male


function checkIsMale(employees) {
    return employees.every(item => item.gender === "Male");
}


console.log(checkIsMale(employees));
