...
function includesFemales(employees) {
    return employees.some(item => item.gender === "Female");
}


console.log(includesFemales(employees));

// 40. Write a function that will ensure that there are engineers in
// the list of employees

function includesEngineers(employees) {
    return employees.some(item => item.isEngineer);
}


console.log(includesEngineers(employees));
