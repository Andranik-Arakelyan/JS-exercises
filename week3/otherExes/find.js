...
console.log(findByName(employees, "Roxine"));
...
function findByNameAndLastname(employees, obj) {
    return employees.find(item => item.firstName === obj.firstName && item.lastName === obj.lastName);
}


console.log(findByNameAndLastname(employees, {firstName: `Flemming`, lastName: `Scroggins`}));
