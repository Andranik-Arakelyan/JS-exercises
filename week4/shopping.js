...
function Product(name, type, price) {
  ...
  ShoppingCart.prototype.replace = function(productName, replacementProduct) {
    for (let i = 0; i < this.products.length; i++) {
  ...
  let coffee = new Product("capucino", "drink", 2);
  
  let fastfood = new Product("pizza", "food", 5);
  
  let clothes = new Product("hat", "clothes", 12);
